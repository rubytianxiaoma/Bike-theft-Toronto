...
time_data %>%
  ...
  geom_line() +stat_peaks(span=24, ignore_threshold = 0.75, color="red") +
  stat_peaks(geom="text", span=24, ignore_threshold = 0.75, x.label.fmt = "%b %Y", color="red", angle=0, hjust=-0.1,vjust = 1) +
  theme_minimal() +
  labs(title = "Cases reported by day in Toronto, Canada",
       subtitle = "With high bicycle stolen rate in red",
       x = "Date",
       y = "Case count",
